 ...
 */
final class Version20221113014925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `lead` (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(50) DEFAULT NULL, last_name VARCHAR(50) DEFAULT NULL, company VARCHAR(50) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, img VARCHAR(50) DEFAULT NULL, street VARCHAR(50) DEFAULT NULL, id_state INT DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, id_country INT DEFAULT NULL, postal_code VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
